...
public interface ScheduleControllerDoc {
    ...
    ScheduleResponse getSchedule(@PathVariable Long scheduleId);
    ...
    List<ScheduleResponse> getScheduleByUser(@PathVariable Long userId);
    ...
    List<ScheduleResponse> getScheduleByCouple(@PathVariable Long coupleId);
    ...
    ScheduleResponse createSchedule(@Valid @RequestBody ScheduleCreateRequest scheduleCreateRequest);
    ...
    ScheduleResponse updateSchedule(@PathVariable Long scheduleId, @Valid @RequestBody ScheduleUpdateRequest scheduleUpdateRequest);
    ...
    ScheduleResponse deleteSchedule(@PathVariable Long scheduleId);
}

...
public class OAuth2UserCustomService extends DefaultOAuth2UserService {
    ...
    private void saveOrUpdate(OAuth2User user) {
        ...
        String nickname =
                (properties != null && properties.containsKey("nickname")) ? (String) properties.get("nickname") : null;

        // Kakao 계정 정보에서 email을 가져옴
        Map<String, Object> kakaoAccount = (Map<String, Object>) attribute.get("kakao_account");
        String email =
                (kakaoAccount != null && kakaoAccount.containsKey("email")) ? (String) kakaoAccount.get("email") : null;
